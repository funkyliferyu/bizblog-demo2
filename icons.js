...
// Demo output route guard: keep generated breadcrumb links inside static demo files.
if (typeof breadcrumbRouteMap !== 'undefined') {
  const __demoRouteMap = {
    '01_대시보드.html': 'soho_dashboard.html',
    '01_대시보드_온보딩전.html': 'soho_dashboard.html',
    '08_AI콘텐츠생성_목록.html': '02_블로그관리_생성완료.html',
    '11_블로그_발행완료_상세.html': '10_블로그_발행대기_상세.html',
    '06_AI학습_현황_수집실패.html': '06_AI학습_현황.html',
    '06_AI학습_현황_분석실패.html': '06_AI학습_현황.html',
    '06_AI학습_현황_재학습중.html': '06_AI학습_현황.html'
  };
  Object.keys(breadcrumbRouteMap).forEach((page) => {
    breadcrumbRouteMap[page] = breadcrumbRouteMap[page].map(([label, href]) => [label, __demoRouteMap[href] || href]);
  });
}
